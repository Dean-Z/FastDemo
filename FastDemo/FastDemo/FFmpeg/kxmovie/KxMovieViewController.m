...
- (void)loadView
{
    ...
    CGRect bounds = [[[[UIApplication sharedApplication] delegate] window] frame];
    ...
    if ([self subtitleForPosition:_moviePosition
        ...
        if (actual.count) {
            ...
            if (![_subtitlesLabel.text isEqualToString:ms]) {
                ...
                CGSize size = [ms fd_sizeWithFont:_subtitlesLabel.font constrainedToSize:CGSizeMake(viewSize.width, viewSize.height * 0.5)];
