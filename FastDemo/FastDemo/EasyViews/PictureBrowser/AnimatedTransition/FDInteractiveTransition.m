...
@interface FDInteractiveTransition ()
...
@implementation FDInteractiveTransition
...
- (void)setToViewController:(FDAlbumBrowserController *)toViewController {
